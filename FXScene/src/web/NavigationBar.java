...
/*
The code in Listing creates a navigation bar, as shown in Figure 16-3. It boxes all the controls in an HBox. You need to pass the
...
public class NavigationBar extends HBox {
	...
	public NavigationBar(WebView webView, String homePageUrl, boolean goToHomePage) {
		...
		webEngine.locationProperty().addListener(
			(ObservableValue<? extends String> prop, String oldValue, String newValue) -> pageUrl.setText(newValue)
        );
