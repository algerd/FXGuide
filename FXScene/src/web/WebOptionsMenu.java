...
/*
The program creates a WebOptionsMenu class for setting options
for a WebView. It inherits from the MenuButton class. The constructor takes a WebView as an argument.
The class is simple to use; first create an instance for a WebView and add it to a layout pane
*/
