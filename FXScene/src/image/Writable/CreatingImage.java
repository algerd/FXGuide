...
/*
Подробный разбор примера в K.Sharan 1019-1021
...
The program creates an image from scratch. It creates a pattern by writing row pixels for
the rectangular region to fill the image.
*/
