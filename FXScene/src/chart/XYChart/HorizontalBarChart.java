...
The program shows how to create and populate a horizontal bar chart. 
The program needs to supply data to the chart in an ObservableList of XYChart.Series<Number,String>. 
The getYearSeries() method in the XYChartDataUtil class returns XYChart.Series<String,Number>. 
The getChartData() method in the program converts the series data from
...
public class HorizontalBarChart extends Application {
	...
	public void start(Stage stage) {
		...
		ObservableList<XYChart.Series<Number,String>> chartData = this.getChartData(XYChartDataUtil.getYearSeries());
	...
	private ObservableList<XYChart.Series<Number,String>> getChartData(ObservableList<XYChart.Series<String,Number>> oldData) {
        
		ObservableList<XYChart.Series<Number, String>> newData = FXCollections.observableArrayList();

		// Read (String, Number) from old data and convert it into (Nubmer, String) in new data
