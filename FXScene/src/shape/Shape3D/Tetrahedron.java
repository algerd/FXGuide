...
/*
Listing contains a complete program to show how to construct a tetrahedron using a
TriangleMesh. The tetrahedron is rotated along y-axis, so you can view two of its vertical faces.
*/
