...
/*
Listing demonstrates how to create and set a border to a Pane. It displays a screen with two Panes.
One Pane is styled using CSS and another using a Border object.  The program prints the insets 
and outsets for the borders and checks whether both borders are the same or not. 
Both borders use three strokes. The getCSSStyledPane() method returns a Pane styled with
