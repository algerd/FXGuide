...
/*
Background object is immutable. It can be safely used as the background of multiple Regions.
...
The program shows how to set the background for a Pane, which is a Region, using
both the CSS properties and the Background object. The getCSSStyledPane() method creates a Pane, 
adds a background with two fills using CSS, and returns the Pane. 
The getObjectStyledPane() method creates a Pane, adds a background with two fills using Java
