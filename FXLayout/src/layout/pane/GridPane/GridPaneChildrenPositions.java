...
The program is a modified version of the program in GridPaneChildrenList.java. It adds the column
and row indexes to three buttons, so they are positioned in separate columns in one row.
*/
