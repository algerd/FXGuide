...
dragging the mouse over the scene area. Listing shows how to write the code to support dragging of a
...
*/
public class StageDecorateDragging extends Application {
