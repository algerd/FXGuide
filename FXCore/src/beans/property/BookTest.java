...
public class BookTest {
	...
	public static void printDetails(ReadOnlyProperty<?> p) {
        /*
        Методы интерфейса ReadOnlyProperty<?> 
            getName() - возвращает String имя свойства
            getBean() - возвращает объект-bean свойства
            getValue() - метод интерфейса ObservableValue<T> - возвращает объект свойства
        */
