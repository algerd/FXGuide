...
/*
You can transfer data in any format using the drag-and-drop gesture provided the data is Serializable.
The program shows how to use a custom data format in a drag-and-drop gesture.
The window contains two ListViews. Initially, only one of the
