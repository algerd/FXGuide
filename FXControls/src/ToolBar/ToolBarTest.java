...
items. When you click the overflow button, the hidden toolbar items are displayed for selection.
A toolbar can have the orientation of horizontal or vertical. A horizontal toolbar arranges the items
horizontally in one row. A vertical toolbar arranges the items in one column. 
...
a toolbar uses the horizontal orientation.
...
The program ishows how to create and use ToolBar controls. It creates a toolbar and
